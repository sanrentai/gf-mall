...
// arModel is a active record design model for table pms_product_full_reduction operations.
type arModel struct {
	gmvc.M
}

var (
	// Table is the table name of pms_product_full_reduction.
	Table = "pms_product_full_reduction"
	// Model is the model object of pms_product_full_reduction.
	Model = &arModel{g.DB("default").Table(Table).Safe()}
	// Columns defines and stores column names for table pms_product_full_reduction.
	Columns = struct {
		Id           string //   
        ProductId    string //   
        FullPrice    string //   
