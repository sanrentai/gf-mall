...
// arModel is a active record design model for table pms_comment_replay operations.
type arModel struct {
	gmvc.M
}

var (
	// Table is the table name of pms_comment_replay.
	Table = "pms_comment_replay"
	// Model is the model object of pms_comment_replay.
	Model = &arModel{g.DB("default").Table(Table).Safe()}
	// Columns defines and stores column names for table pms_comment_replay.
	Columns = struct {
		Id              string //                                   
        CommentId       string //                                   
