...
// arModel is a active record design model for table ums_growth_change_history operations.
type arModel struct {
	gmvc.M
}

var (
	// Table is the table name of ums_growth_change_history.
	Table = "ums_growth_change_history"
	// Model is the model object of ums_growth_change_history.
	Model = &arModel{g.DB("default").Table(Table).Safe()}
	// Columns defines and stores column names for table ums_growth_change_history.
	Columns = struct {
		Id           string //                                   
        MemberId     string //                                   
        CreateTime   string //                                   
