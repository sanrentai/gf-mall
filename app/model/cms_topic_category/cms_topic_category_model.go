...
// arModel is a active record design model for table cms_topic_category operations.
type arModel struct {
	gmvc.M
}

var (
	// Table is the table name of cms_topic_category.
	Table = "cms_topic_category"
	// Model is the model object of cms_topic_category.
	Model = &arModel{g.DB("default").Table(Table).Safe()}
	// Columns defines and stores column names for table cms_topic_category.
	Columns = struct {
		Id            string //           
        Name          string //           
        Icon          string // 分类图标  
