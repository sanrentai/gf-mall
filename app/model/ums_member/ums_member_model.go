...
// arModel is a active record design model for table ums_member operations.
type arModel struct {
	gmvc.M
}

var (
	// Table is the table name of ums_member.
	Table = "ums_member"
	// Model is the model object of ums_member.
	Model = &arModel{g.DB("default").Table(Table).Safe()}
	// Columns defines and stores column names for table ums_member.
	Columns = struct {
		Id                     string //                                
