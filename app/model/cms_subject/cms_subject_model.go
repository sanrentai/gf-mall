...
// arModel is a active record design model for table cms_subject operations.
type arModel struct {
	gmvc.M
}

var (
	// Table is the table name of cms_subject.
	Table = "cms_subject"
	// Model is the model object of cms_subject.
	Model = &arModel{g.DB("default").Table(Table).Safe()}
	// Columns defines and stores column names for table cms_subject.
	Columns = struct {
		Id               string //                               
        CategoryId       string //                               
        Title            string //                               
        Pic              string // 专题主图                      
        ProductCount     string // 关联产品数量                  
