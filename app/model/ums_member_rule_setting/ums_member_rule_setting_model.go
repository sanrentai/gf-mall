...
// arModel is a active record design model for table ums_member_rule_setting operations.
type arModel struct {
	gmvc.M
}

var (
	// Table is the table name of ums_member_rule_setting.
	Table = "ums_member_rule_setting"
	// Model is the model object of ums_member_rule_setting.
	Model = &arModel{g.DB("default").Table(Table).Safe()}
	// Columns defines and stores column names for table ums_member_rule_setting.
	Columns = struct {
		Id                 string //                                   
