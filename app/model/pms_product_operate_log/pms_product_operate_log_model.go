...
// arModel is a active record design model for table pms_product_operate_log operations.
type arModel struct {
	gmvc.M
}

var (
	// Table is the table name of pms_product_operate_log.
	Table = "pms_product_operate_log"
	// Model is the model object of pms_product_operate_log.
	Model = &arModel{g.DB("default").Table(Table).Safe()}
	// Columns defines and stores column names for table pms_product_operate_log.
	Columns = struct {
		Id                string //             
        ProductId         string //             
        PriceOld          string //             
        ...
        SalePriceOld      string //             
        SalePriceNew      string //             
        GiftPointOld      string // 赠送的积分  
        GiftPointNew      string //             
        UsePointLimitOld  string //             
        UsePointLimitNew  string //             
        ...
        PriceOld:         "price_old",            
        PriceNew:         "price_new",            
        SalePriceOld:     "sale_price_old",       
        SalePriceNew:     "sale_price_new",       
        GiftPointOld:     "gift_point_old",       
        GiftPointNew:     "gift_point_new",       
        UsePointLimitOld: "use_point_limit_old",  
        UsePointLimitNew: "use_point_limit_new",  
        OperateMan:       "operate_man",          
