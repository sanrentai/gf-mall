...
// arModel is a active record design model for table cms_topic_comment operations.
type arModel struct {
	gmvc.M
}

var (
	// Table is the table name of cms_topic_comment.
	Table = "cms_topic_comment"
	// Model is the model object of cms_topic_comment.
	Model = &arModel{g.DB("default").Table(Table).Safe()}
	// Columns defines and stores column names for table cms_topic_comment.
	Columns = struct {
		Id              string //   
