...
// arModel is a active record design model for table sms_coupon_product_category_relation operations.
type arModel struct {
	gmvc.M
}

var (
	// Table is the table name of sms_coupon_product_category_relation.
	Table = "sms_coupon_product_category_relation"
	// Model is the model object of sms_coupon_product_category_relation.
	Model = &arModel{g.DB("default").Table(Table).Safe()}
	// Columns defines and stores column names for table sms_coupon_product_category_relation.
	Columns = struct {
		Id                   string //               
        CouponId             string //               
