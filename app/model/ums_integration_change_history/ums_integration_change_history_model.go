...
// arModel is a active record design model for table ums_integration_change_history operations.
type arModel struct {
	gmvc.M
}

var (
	// Table is the table name of ums_integration_change_history.
	Table = "ums_integration_change_history"
	// Model is the model object of ums_integration_change_history.
	Model = &arModel{g.DB("default").Table(Table).Safe()}
	// Columns defines and stores column names for table ums_integration_change_history.
	Columns = struct {
		Id           string //                                   
        MemberId     string //                                   
        CreateTime   string //                                   
        ChangeType   string // 改变类型：0->增加；1->减少        
        ChangeCount  string // 积分改变数量                      
        OperateMan   string // 操作人员                          
        OperateNote  string // 操作备注                          
        SourceType   string // 积分来源：0->购物；1->管理员修改
	}{
		Id:          "id",            
        MemberId:    "member_id",     
