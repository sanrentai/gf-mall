...
// arModel is a active record design model for table cms_topic operations.
type arModel struct {
	gmvc.M
}

var (
	// Table is the table name of cms_topic.
	Table = "cms_topic"
	// Model is the model object of cms_topic.
	Model = &arModel{g.DB("default").Table(Table).Safe()}
	// Columns defines and stores column names for table cms_topic.
	Columns = struct {
		Id              string //           
        CategoryId      string //           
        Name            string //           
        ...
        StartTime       string //           
        EndTime         string //           
        AttendCount     string // 参与人数  
        AttentionCount  string // 关注人数  
        ReadCount       string //           
