...
// arModel is a active record design model for table sms_flash_promotion_log operations.
type arModel struct {
	gmvc.M
}

var (
	// Table is the table name of sms_flash_promotion_log.
	Table = "sms_flash_promotion_log"
	// Model is the model object of sms_flash_promotion_log.
	Model = &arModel{g.DB("default").Table(Table).Safe()}
	// Columns defines and stores column names for table sms_flash_promotion_log.
	Columns = struct {
		Id             string //               
        MemberId       string //               
        ProductId      string //               
