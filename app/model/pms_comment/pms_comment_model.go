...
// arModel is a active record design model for table pms_comment operations.
type arModel struct {
	gmvc.M
}

var (
	// Table is the table name of pms_comment.
	Table = "pms_comment"
	// Model is the model object of pms_comment.
	Model = &arModel{g.DB("default").Table(Table).Safe()}
	// Columns defines and stores column names for table pms_comment.
	Columns = struct {
		Id                string //                           
        ProductId         string //                           
        MemberNickName    string //                           
        ProductName       string //                           
        Star              string // 评价星数：0->5            
        MemberIp          string // 评价的ip                  
        CreateTime        string //                           
        ShowStatus        string //                           
        ProductAttribute  string // 购买时的商品属性          
        CollectCouont     string //                           
        ReadCount         string //                           
        Content           string //                           
        ...
        MemberNickName:   "member_nick_name",   
