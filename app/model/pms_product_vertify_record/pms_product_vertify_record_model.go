...
// arModel is a active record design model for table pms_product_vertify_record operations.
type arModel struct {
	gmvc.M
}

var (
	// Table is the table name of pms_product_vertify_record.
	Table = "pms_product_vertify_record"
	// Model is the model object of pms_product_vertify_record.
	Model = &arModel{g.DB("default").Table(Table).Safe()}
	// Columns defines and stores column names for table pms_product_vertify_record.
	Columns = struct {
		Id          string //           
        ProductId   string //           
        CreateTime  string //           
