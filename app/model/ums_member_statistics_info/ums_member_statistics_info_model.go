...
// arModel is a active record design model for table ums_member_statistics_info operations.
type arModel struct {
	gmvc.M
}

var (
	// Table is the table name of ums_member_statistics_info.
	Table = "ums_member_statistics_info"
	// Model is the model object of ums_member_statistics_info.
	Model = &arModel{g.DB("default").Table(Table).Safe()}
	// Columns defines and stores column names for table ums_member_statistics_info.
	Columns = struct {
		Id                   string //                     
        MemberId             string //                     
