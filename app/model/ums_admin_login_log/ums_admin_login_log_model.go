...
// arModel is a active record design model for table ums_admin_login_log operations.
type arModel struct {
	gmvc.M
}

var (
	// Table is the table name of ums_admin_login_log.
	Table = "ums_admin_login_log"
	// Model is the model object of ums_admin_login_log.
	Model = &arModel{g.DB("default").Table(Table).Safe()}
	// Columns defines and stores column names for table ums_admin_login_log.
	Columns = struct {
		Id          string //                 
        AdminId     string //                 
        CreateTime  string //                 
