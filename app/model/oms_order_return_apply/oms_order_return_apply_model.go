...
// arModel is a active record design model for table oms_order_return_apply operations.
type arModel struct {
	gmvc.M
}

var (
	// Table is the table name of oms_order_return_apply.
	Table = "oms_order_return_apply"
	// Model is the model object of oms_order_return_apply.
	Model = &arModel{g.DB("default").Table(Table).Safe()}
	// Columns defines and stores column names for table oms_order_return_apply.
	Columns = struct {
		Id                string //                                                       
        OrderId           string // 订单id                                                
        CompanyAddressId  string // 收货地址表id                                          
        ProductId         string // 退货商品id                                            
        OrderSn           string // 订单编号                                              
        ...
        ProductRealPrice: "product_real_price",  
        Reason:           "reason",              
        Description:      "description",         
        ProofPics:        "proof_pics",          
        HandleNote:       "handle_note",         
