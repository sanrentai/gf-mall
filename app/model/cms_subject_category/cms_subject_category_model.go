...
// arModel is a active record design model for table cms_subject_category operations.
type arModel struct {
	gmvc.M
}

var (
	// Table is the table name of cms_subject_category.
	Table = "cms_subject_category"
	// Model is the model object of cms_subject_category.
	Model = &arModel{g.DB("default").Table(Table).Safe()}
	// Columns defines and stores column names for table cms_subject_category.
	Columns = struct {
		Id            string //           
        Name          string //           
        Icon          string // 分类图标  
        SubjectCount  string // 专题数量  
        ShowStatus    string //           
        Sort          string //
	}{
		Id:           "id",             
