...
// arModel is a active record design model for table ums_role_menu_relation operations.
type arModel struct {
	gmvc.M
}

var (
	// Table is the table name of ums_role_menu_relation.
	Table = "ums_role_menu_relation"
	// Model is the model object of ums_role_menu_relation.
	Model = &arModel{g.DB("default").Table(Table).Safe()}
	// Columns defines and stores column names for table ums_role_menu_relation.
	Columns = struct {
		Id      string //         
        RoleId  string // 角色ID  
        MenuId  string // 菜单ID
