...
// arModel is a active record design model for table pms_product_attribute_value operations.
type arModel struct {
	gmvc.M
}

var (
	// Table is the table name of pms_product_attribute_value.
	Table = "pms_product_attribute_value"
	// Model is the model object of pms_product_attribute_value.
	Model = &arModel{g.DB("default").Table(Table).Safe()}
	// Columns defines and stores column names for table pms_product_attribute_value.
	Columns = struct {
		Id                  string //                                                           
        ProductId           string //                                                           
