...
// arModel is a active record design model for table cms_help operations.
type arModel struct {
	gmvc.M
}

var (
	// Table is the table name of cms_help.
	Table = "cms_help"
	// Model is the model object of cms_help.
	Model = &arModel{g.DB("default").Table(Table).Safe()}
	// Columns defines and stores column names for table cms_help.
	Columns = struct {
		Id          string //   
        CategoryId  string //   
        Icon        string //   
