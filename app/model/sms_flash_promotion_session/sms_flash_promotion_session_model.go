...
// arModel is a active record design model for table sms_flash_promotion_session operations.
type arModel struct {
	gmvc.M
}

var (
	// Table is the table name of sms_flash_promotion_session.
	Table = "sms_flash_promotion_session"
	// Model is the model object of sms_flash_promotion_session.
	Model = &arModel{g.DB("default").Table(Table).Safe()}
	// Columns defines and stores column names for table sms_flash_promotion_session.
	Columns = struct {
		Id          string // 编号                          
        Name        string // 场次名称                      
        StartTime   string // 每日开始时间                  
        EndTime     string // 每日结束时间                  
        Status      string // 启用状态：0->不启用；1->启用  
