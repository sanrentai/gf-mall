...
// arModel is a active record design model for table sms_flash_promotion operations.
type arModel struct {
	gmvc.M
}

var (
	// Table is the table name of sms_flash_promotion.
	Table = "sms_flash_promotion"
	// Model is the model object of sms_flash_promotion.
	Model = &arModel{g.DB("default").Table(Table).Safe()}
	// Columns defines and stores column names for table sms_flash_promotion.
	Columns = struct {
		Id          string //                 
        Title       string //                 
