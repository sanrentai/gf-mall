...
// arModel is a active record design model for table cms_prefrence_area operations.
type arModel struct {
	gmvc.M
}

var (
	// Table is the table name of cms_prefrence_area.
	Table = "cms_prefrence_area"
	// Model is the model object of cms_prefrence_area.
	Model = &arModel{g.DB("default").Table(Table).Safe()}
	// Columns defines and stores column names for table cms_prefrence_area.
	Columns = struct {
		Id          string //           
        Name        string //           
        SubTitle    string //           
