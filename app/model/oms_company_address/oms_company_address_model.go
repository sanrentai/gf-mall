...
// arModel is a active record design model for table oms_company_address operations.
type arModel struct {
	gmvc.M
}

var (
	// Table is the table name of oms_company_address.
	Table = "oms_company_address"
	// Model is the model object of oms_company_address.
	Model = &arModel{g.DB("default").Table(Table).Safe()}
	// Columns defines and stores column names for table oms_company_address.
	Columns = struct {
		Id             string //                                 
        AddressName    string // 地址名称                        
        SendStatus     string // 默认发货地址：0->否；1->是      
        ReceiveStatus  string // 是否默认收货地址：0->否；1->是  
        Name           string // 收发货人姓名                    
        Phone          string // 收货人电话                      
