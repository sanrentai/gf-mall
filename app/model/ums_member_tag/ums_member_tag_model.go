...
// arModel is a active record design model for table ums_member_tag operations.
type arModel struct {
	gmvc.M
}

var (
	// Table is the table name of ums_member_tag.
	Table = "ums_member_tag"
	// Model is the model object of ums_member_tag.
	Model = &arModel{g.DB("default").Table(Table).Safe()}
	// Columns defines and stores column names for table ums_member_tag.
	Columns = struct {
		Id                 string //                         
        Name               string //                         
