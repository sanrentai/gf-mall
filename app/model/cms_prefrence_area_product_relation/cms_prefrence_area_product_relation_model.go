...
// arModel is a active record design model for table cms_prefrence_area_product_relation operations.
type arModel struct {
	gmvc.M
}

var (
	// Table is the table name of cms_prefrence_area_product_relation.
	Table = "cms_prefrence_area_product_relation"
	// Model is the model object of cms_prefrence_area_product_relation.
	Model = &arModel{g.DB("default").Table(Table).Safe()}
	// Columns defines and stores column names for table cms_prefrence_area_product_relation.
	Columns = struct {
		Id               string //   
		...
		Id:              "id",                 
        PrefrenceAreaId: "prefrence_area_id",  
