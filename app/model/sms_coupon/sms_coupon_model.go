...
// arModel is a active record design model for table sms_coupon operations.
type arModel struct {
	gmvc.M
}

var (
	// Table is the table name of sms_coupon.
	Table = "sms_coupon"
	// Model is the model object of sms_coupon.
	Model = &arModel{g.DB("default").Table(Table).Safe()}
	// Columns defines and stores column names for table sms_coupon.
	Columns = struct {
		Id            string //                                                                 
        Type          string // 优惠卷类型；0->全场赠券；1->会员赠券；2->购物赠券；3->注册赠券  
        Name          string //                                                                 
        Platform      string // 使用平台：0->全部；1->移动；2->PC                               
        Count         string // 数量                                                            
        Amount        string // 金额                                                            
        ...
        StartTime     string //                                                                 
        EndTime       string //                                                                 
        UseType       string // 使用类型：0->全场通用；1->指定分类；2->指定商品                 
        Note          string // 备注                                                            
        PublishCount  string // 发行数量                                                        
        UseCount      string // 已使用数量                                                      
        ReceiveCount  string // 领取数量                                                        
        EnableTime    string // 可以领取的日期                                                  
        Code          string // 优惠码                                                          
        MemberLevel   string // 可领取的会员类型：0->无限时
	}{
		Id:           "id",             
        Type:         "type",           
        Name:         "name",           
