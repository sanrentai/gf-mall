...
// arModel is a active record design model for table oms_order_item operations.
type arModel struct {
	gmvc.M
}

var (
	// Table is the table name of oms_order_item.
	Table = "oms_order_item"
	// Model is the model object of oms_order_item.
	Model = &arModel{g.DB("default").Table(Table).Safe()}
	// Columns defines and stores column names for table oms_order_item.
	Columns = struct {
		Id                 string //                                                                           
        OrderId            string // 订单id                                                                    
        OrderSn            string // 订单编号                                                                  
        ...
        ProductBrand       string //                                                                           
        ProductSn          string //                                                                           
        ProductPrice       string // 销售价格                                                                  
        ProductQuantity    string // 购买数量                                                                  
        ProductSkuId       string // 商品sku编号                                                               
        ProductSkuCode     string // 商品sku条码                                                               
        ProductCategoryId  string // 商品分类id                                                                
        PromotionName      string // 商品促销名称                                                              
        PromotionAmount    string // 商品促销分解金额                                                          
        CouponAmount       string // 优惠券优惠分解金额                                                        
        IntegrationAmount  string // 积分优惠分解金额                                                          
        RealAmount         string // 该商品经过优惠后的分解金额                                                
        ...
        GiftIntegration:   "gift_integration",     
