...
// arModel is a active record design model for table pms_album operations.
type arModel struct {
	gmvc.M
}

var (
	// Table is the table name of pms_album.
	Table = "pms_album"
	// Model is the model object of pms_album.
	Model = &arModel{g.DB("default").Table(Table).Safe()}
	// Columns defines and stores column names for table pms_album.
	Columns = struct {
		Id           string //   
        Name         string //   
        CoverPic     string //   
