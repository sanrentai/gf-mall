...
// arModel is a active record design model for table oms_order operations.
type arModel struct {
	gmvc.M
}

var (
	// Table is the table name of oms_order.
	Table = "oms_order"
	// Model is the model object of oms_order.
	Model = &arModel{g.DB("default").Table(Table).Safe()}
	// Columns defines and stores column names for table oms_order.
	Columns = struct {
		Id                     string // 订单id                                                                        
        MemberId               string //                                                                               
        CouponId               string //                                                                               
        ...
        PayType                string // 支付方式：0->未支付；1->支付宝；2->微信                                       
        SourceType             string // 订单来源：0->PC订单；1->app订单                                               
        Status                 string // 订单状态：0->待付款；1->待发货；2->已发货；3->已完成；4->已关闭；5->无效订单  
        OrderType              string // 订单类型：0->正常订单；1->秒杀订单                                            
        DeliveryCompany        string // 物流公司(配送方式)                                                            
        DeliverySn             string // 物流单号                                                                      
        AutoConfirmDay         string // 自动确认时间（天）                                                            
        Integration            string // 可以获得的积分                                                                
        Growth                 string // 可以活动的成长值                                                              
        PromotionInfo          string // 活动信息                                                                      
        BillType               string // 发票类型：0->不开发票；1->电子发票；2->纸质发票                               
        ...
        Note                   string // 订单备注                                                                      
        ConfirmStatus          string // 确认收货状态：0->未确认；1->已确认                                            
        DeleteStatus           string // 删除状态：0->未删除；1->已删除                                                
        UseIntegration         string // 下单时使用的积分                                                              
        ...
        BillType:              "bill_type",                
        BillHeader:            "bill_header",              
        BillContent:           "bill_content",             
        BillReceiverPhone:     "bill_receiver_phone",      
        BillReceiverEmail:     "bill_receiver_email",      
