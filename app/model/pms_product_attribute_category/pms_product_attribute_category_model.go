...
// arModel is a active record design model for table pms_product_attribute_category operations.
type arModel struct {
	gmvc.M
}

var (
	// Table is the table name of pms_product_attribute_category.
	Table = "pms_product_attribute_category"
	// Model is the model object of pms_product_attribute_category.
	Model = &arModel{g.DB("default").Table(Table).Safe()}
	// Columns defines and stores column names for table pms_product_attribute_category.
	Columns = struct {
		Id              string //           
        Name            string //           
        AttributeCount  string // 属性数量  
