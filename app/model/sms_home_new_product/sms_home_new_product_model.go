...
// arModel is a active record design model for table sms_home_new_product operations.
type arModel struct {
	gmvc.M
}

var (
	// Table is the table name of sms_home_new_product.
	Table = "sms_home_new_product"
	// Model is the model object of sms_home_new_product.
	Model = &arModel{g.DB("default").Table(Table).Safe()}
	// Columns defines and stores column names for table sms_home_new_product.
	Columns = struct {
		Id               string //   
        ProductId        string //   
        ProductName      string //   
