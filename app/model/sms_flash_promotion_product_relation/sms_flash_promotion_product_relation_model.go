...
// arModel is a active record design model for table sms_flash_promotion_product_relation operations.
type arModel struct {
	gmvc.M
}

var (
	// Table is the table name of sms_flash_promotion_product_relation.
	Table = "sms_flash_promotion_product_relation"
	// Model is the model object of sms_flash_promotion_product_relation.
	Model = &arModel{g.DB("default").Table(Table).Safe()}
	// Columns defines and stores column names for table sms_flash_promotion_product_relation.
	Columns = struct {
		Id                       string // 编号          
        FlashPromotionId         string //               
        FlashPromotionSessionId  string // 编号          
        ProductId                string //               
        FlashPromotionPrice      string // 限时购价格    
        FlashPromotionCount      string // 限时购数量    
        FlashPromotionLimit      string // 每人限购数量  
        Sort                     string // 排序
	}{
		Id:                      "id",                          
        ...
        FlashPromotionPrice:     "flash_promotion_price",       
        FlashPromotionCount:     "flash_promotion_count",       
        FlashPromotionLimit:     "flash_promotion_limit",       
        Sort:                    "sort",
	}
)
