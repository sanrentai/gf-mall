...
// arModel is a active record design model for table sms_home_brand operations.
type arModel struct {
	gmvc.M
}

var (
	// Table is the table name of sms_home_brand.
	Table = "sms_home_brand"
	// Model is the model object of sms_home_brand.
	Model = &arModel{g.DB("default").Table(Table).Safe()}
	// Columns defines and stores column names for table sms_home_brand.
	Columns = struct {
		Id               string //   
        BrandId          string //   
        BrandName        string //   
