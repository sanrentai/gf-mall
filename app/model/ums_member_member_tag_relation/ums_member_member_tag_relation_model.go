...
// arModel is a active record design model for table ums_member_member_tag_relation operations.
type arModel struct {
	gmvc.M
}

var (
	// Table is the table name of ums_member_member_tag_relation.
	Table = "ums_member_member_tag_relation"
	// Model is the model object of ums_member_member_tag_relation.
	Model = &arModel{g.DB("default").Table(Table).Safe()}
	// Columns defines and stores column names for table ums_member_member_tag_relation.
	Columns = struct {
		Id        string //   
        MemberId  string //   
        TagId     string //
