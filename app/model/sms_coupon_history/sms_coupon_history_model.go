...
// arModel is a active record design model for table sms_coupon_history operations.
type arModel struct {
	gmvc.M
}

var (
	// Table is the table name of sms_coupon_history.
	Table = "sms_coupon_history"
	// Model is the model object of sms_coupon_history.
	Model = &arModel{g.DB("default").Table(Table).Safe()}
	// Columns defines and stores column names for table sms_coupon_history.
	Columns = struct {
		Id              string //                                            
        CouponId        string //                                            
        MemberId        string //                                            
        ...
        GetType         string // 获取类型：0->后台赠送；1->主动获取         
        CreateTime      string //                                            
