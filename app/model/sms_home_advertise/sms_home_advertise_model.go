...
// arModel is a active record design model for table sms_home_advertise operations.
type arModel struct {
	gmvc.M
}

var (
	// Table is the table name of sms_home_advertise.
	Table = "sms_home_advertise"
	// Model is the model object of sms_home_advertise.
	Model = &arModel{g.DB("default").Table(Table).Safe()}
	// Columns defines and stores column names for table sms_home_advertise.
	Columns = struct {
		Id          string //                                          
        Name        string //                                          
        Type        string // 轮播位置：0->PC首页轮播；1->app首页轮播  
        Pic         string //                                          
        StartTime   string //                                          
        EndTime     string //                                          
        Status      string // 上下线状态：0->下线；1->上线             
        ClickCount  string // 点击数                                   
        OrderCount  string // 下单数                                   
        Url         string // 链接地址                                 
        Note        string // 备注                                     
        Sort        string // 排序
	}{
