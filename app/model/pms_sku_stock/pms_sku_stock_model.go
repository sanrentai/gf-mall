...
// arModel is a active record design model for table pms_sku_stock operations.
type arModel struct {
	gmvc.M
}

var (
	// Table is the table name of pms_sku_stock.
	Table = "pms_sku_stock"
	// Model is the model object of pms_sku_stock.
	Model = &arModel{g.DB("default").Table(Table).Safe()}
	// Columns defines and stores column names for table pms_sku_stock.
	Columns = struct {
		Id              string //                         
        ProductId       string //                         
