...
// arModel is a active record design model for table sms_home_recommend_subject operations.
type arModel struct {
	gmvc.M
}

var (
	// Table is the table name of sms_home_recommend_subject.
	Table = "sms_home_recommend_subject"
	// Model is the model object of sms_home_recommend_subject.
	Model = &arModel{g.DB("default").Table(Table).Safe()}
	// Columns defines and stores column names for table sms_home_recommend_subject.
	Columns = struct {
		Id               string //   
        SubjectId        string //   
        SubjectName      string //   
