...
// arModel is a active record design model for table pms_product_ladder operations.
type arModel struct {
	gmvc.M
}

var (
	// Table is the table name of pms_product_ladder.
	Table = "pms_product_ladder"
	// Model is the model object of pms_product_ladder.
	Model = &arModel{g.DB("default").Table(Table).Safe()}
	// Columns defines and stores column names for table pms_product_ladder.
	Columns = struct {
		Id         string //                 
        ProductId  string //                 
        Count      string // 满足的商品数量  
        Discount   string // 折扣            
        Price      string // 折后价格
	}{
		Id:        "id",          
