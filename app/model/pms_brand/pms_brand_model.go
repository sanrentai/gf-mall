...
// arModel is a active record design model for table pms_brand operations.
type arModel struct {
	gmvc.M
}

var (
	// Table is the table name of pms_brand.
	Table = "pms_brand"
	// Model is the model object of pms_brand.
	Model = &arModel{g.DB("default").Table(Table).Safe()}
	// Columns defines and stores column names for table pms_brand.
	Columns = struct {
		Id                   string //                                   
        Name                 string //                                   
        FirstLetter          string // 首字母                            
        Sort                 string //                                   
        FactoryStatus        string // 是否为品牌制造商：0->不是；1->是  
        ShowStatus           string //                                   
        ProductCount         string // 产品数量                          
        ProductCommentCount  string // 产品评论数量                      
        Logo                 string // 品牌logo                          
        BigPic               string // 专区大图                          
