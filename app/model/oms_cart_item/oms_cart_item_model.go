...
// arModel is a active record design model for table oms_cart_item operations.
type arModel struct {
	gmvc.M
}

var (
	// Table is the table name of oms_cart_item.
	Table = "oms_cart_item"
	// Model is the model object of oms_cart_item.
	Model = &arModel{g.DB("default").Table(Table).Safe()}
	// Columns defines and stores column names for table oms_cart_item.
	Columns = struct {
		Id                 string //                                                                           
        ProductId          string //                                                                           
        ProductSkuId       string //                                                                           
        ...
        DeleteStatus       string // 是否删除                                                                  
        ProductCategoryId  string // 商品分类                                                                  
        ProductBrand       string //                                                                           
        ProductSn          string //                                                                           
