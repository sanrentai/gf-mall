...
// arModel is a active record design model for table ums_admin_permission_relation operations.
type arModel struct {
	gmvc.M
}

var (
	// Table is the table name of ums_admin_permission_relation.
	Table = "ums_admin_permission_relation"
	// Model is the model object of ums_admin_permission_relation.
	Model = &arModel{g.DB("default").Table(Table).Safe()}
	// Columns defines and stores column names for table ums_admin_permission_relation.
	Columns = struct {
		Id            string //   
        AdminId       string //   
        PermissionId  string //   
