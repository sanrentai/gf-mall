...
// arModel is a active record design model for table ums_member_task operations.
type arModel struct {
	gmvc.M
}

var (
	// Table is the table name of ums_member_task.
	Table = "ums_member_task"
	// Model is the model object of ums_member_task.
	Model = &arModel{g.DB("default").Table(Table).Safe()}
	// Columns defines and stores column names for table ums_member_task.
	Columns = struct {
		Id            string //                                     
        Name          string //                                     
        Growth        string // 赠送成长值                          
