...
// arModel is a active record design model for table ums_role operations.
type arModel struct {
	gmvc.M
}

var (
	// Table is the table name of ums_role.
	Table = "ums_role"
	// Model is the model object of ums_role.
	Model = &arModel{g.DB("default").Table(Table).Safe()}
	// Columns defines and stores column names for table ums_role.
	Columns = struct {
		Id           string //                             
        Name         string // 名称                        
        Description  string // 描述                        
        AdminCount   string // 后台用户数量                
