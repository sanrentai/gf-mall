...
// arModel is a active record design model for table pms_album_pic operations.
type arModel struct {
	gmvc.M
}

var (
	// Table is the table name of pms_album_pic.
	Table = "pms_album_pic"
	// Model is the model object of pms_album_pic.
	Model = &arModel{g.DB("default").Table(Table).Safe()}
	// Columns defines and stores column names for table pms_album_pic.
	Columns = struct {
		Id       string //   
        AlbumId  string //   
        Pic      string //
