...
// arModel is a active record design model for table ums_menu operations.
type arModel struct {
	gmvc.M
}

var (
	// Table is the table name of ums_menu.
	Table = "ums_menu"
	// Model is the model object of ums_menu.
	Model = &arModel{g.DB("default").Table(Table).Safe()}
	// Columns defines and stores column names for table ums_menu.
	Columns = struct {
		Id          string //           
