...
// arModel is a active record design model for table pms_feight_template operations.
type arModel struct {
	gmvc.M
}

var (
	// Table is the table name of pms_feight_template.
	Table = "pms_feight_template"
	// Model is the model object of pms_feight_template.
	Model = &arModel{g.DB("default").Table(Table).Safe()}
	// Columns defines and stores column names for table pms_feight_template.
	Columns = struct {
		Id              string //                                
        Name            string //                                
        ChargeType      string // 计费类型:0->按重量；1->按件数  
        ...
        FirstFee:       "first_fee",        
        ContinueWeight: "continue_weight",  
        ContinmeFee:    "continme_fee",     
        Dest:           "dest",
	}
)
