...
// arModel is a active record design model for table ums_member_receive_address operations.
type arModel struct {
	gmvc.M
}

var (
	// Table is the table name of ums_member_receive_address.
	Table = "ums_member_receive_address"
	// Model is the model object of ums_member_receive_address.
	Model = &arModel{g.DB("default").Table(Table).Safe()}
	// Columns defines and stores column names for table ums_member_receive_address.
	Columns = struct {
		Id             string //                 
        MemberId       string //                 
        Name           string // 收货人名称      
