...
// arModel is a active record design model for table ums_resource operations.
type arModel struct {
	gmvc.M
}

var (
	// Table is the table name of ums_resource.
	Table = "ums_resource"
	// Model is the model object of ums_resource.
	Model = &arModel{g.DB("default").Table(Table).Safe()}
	// Columns defines and stores column names for table ums_resource.
	Columns = struct {
		Id           string //             
