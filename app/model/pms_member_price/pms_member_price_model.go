...
// arModel is a active record design model for table pms_member_price operations.
type arModel struct {
	gmvc.M
}

var (
	// Table is the table name of pms_member_price.
	Table = "pms_member_price"
	// Model is the model object of pms_member_price.
	Model = &arModel{g.DB("default").Table(Table).Safe()}
	// Columns defines and stores column names for table pms_member_price.
	Columns = struct {
		Id               string //           
        ProductId        string //           
