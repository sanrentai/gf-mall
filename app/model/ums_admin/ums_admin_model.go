...
// arModel is a active record design model for table ums_admin operations.
type arModel struct {
	gmvc.M
}

var (
	// Table is the table name of ums_admin.
	Table = "ums_admin"
	// Model is the model object of ums_admin.
	Model = &arModel{g.DB("default").Table(Table).Safe()}
	// Columns defines and stores column names for table ums_admin.
	Columns = struct {
		Id          string //                                 
        Username    string //                                 
        Password    string //                                 
