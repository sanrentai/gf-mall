...
// arModel is a active record design model for table ums_resource_category operations.
type arModel struct {
	gmvc.M
}

var (
	// Table is the table name of ums_resource_category.
	Table = "ums_resource_category"
	// Model is the model object of ums_resource_category.
	Model = &arModel{g.DB("default").Table(Table).Safe()}
	// Columns defines and stores column names for table ums_resource_category.
	Columns = struct {
		Id          string //           
